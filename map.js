	...
	firecenter[0] = [9,39.912650,-105.001492]; //default -- state of Colorado
    ...
    layers[1] = new google.maps.FusionTablesLayer({
      ...
      query: {
        select: "col18\x3e\x3e1",
        from: "1_7u7oLfIeoCQrOuc6AYiKY-Zr0o8M5zhKJYksN8",
        where: ""
      },
      options: {
        styleId: 2,
    ...
    //layers[1] = new google.maps.KmlLayer('http://extras.denverpost.com/media/maps/kml/2013/2013Coloradofloods-rain-20130912-2048.kmz', {preserveViewport: true});
    layers[2] = new google.maps.KmlLayer('http://extras.denverpost.com/media/maps/kml/2013/2013Coloradoflood-stories-20130917-1335.kml', {preserveViewport: true});
	layers[3] = new google.maps.KmlLayer('http://extras.denverpost.com/media/maps/kml/2013/2013Coloradoflooding-shelters-20130917-1159.kml', {preserveViewport: true});
	layers[4] = new google.maps.KmlLayer('http://extras.denverpost.com/media/maps/kml/2013/2013Coloradoflooding-water-20130917-1024.kml', {preserveViewport: true});
